...
class PdfInvoiceService {
  void createHelloWorld() async {
    ...
    final file = File('${dir.path}/pola.pdf');
    
    await file.writeAsBytes(bytes);
  }

  Future<Uint8List> createInvoice(List<Produit> soldProducts) async {
    final pdf = pw.Document();
  ...
  Future<void> savePdfFile(String fileName, Uint8List byteList) async {
    ...
    print("J'ai ouvert la facture");
  }

  String getSubTotal(List<Produit> products) {
    return products
        .fold(0.0,
  ...
  String getVatTotal(List<Produit> products) {
    return products
        .fold(
          0.0,
          (double prev, next) =>
